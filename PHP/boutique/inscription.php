...
if($_POST)
{
  ...
  if(empty($erreur))
  {
    ...
    $content .= '<div class="alert alert-success col-md-8 col-md-offset-2 texte-center">Vous êtes inscris sur notre site web ! <a href="connexion.php" class="alert-link">Cliquez ici pour vous connecter</a></div>';
  }
}
