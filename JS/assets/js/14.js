/* ------------------------------------------------------------------------------------
    ...
    OBJECTIF : Etre en mesure de capturer ces événements afin 
    d'executer une fonction.

    Les Evenements : MOUSE (Souris)

        click       : au clic sur un élément ;
        mouseenter  : la souris passe au dessus de la zone d'un élément(:hoverCSS) ;
    ...
    Pour attacher un Evenement à un élément ou autrement dit, pour déclarer un écouteur
    d'Evenement qui se chargera de déclencher une fonction, je vais utiliser la syntaxe
    suivante :
...
p.addEventListener('click', changeColorInRed);
